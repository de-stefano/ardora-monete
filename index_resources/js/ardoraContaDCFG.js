...
var m=["c010","c020","c050","c100","c200","cB5","cB10","cB20"];
var values=[100,200,500,1000,2000,5000,10000,20000];
var tiC=[5,5,5,5,5,5,5,5];
var imaH=[0];
var totEuros=0;var totCent=0;var nameEuro="€";var nameCent="Cént.";
var te=["Compro due pacchetti di caramelle che costano 1€ e 40 l\'uno; pago con una banconota da 10€; che cifra mi sarà data come resto?"];var im=[""];var a1=[""];var imalt=[""];
var indexGame=0;var totCentFixed=0; var totEurosFixed=0; var avaiCoins=[];var correct=[];
var ce=[200];var eu=[7000];var ram_G=[-1];
